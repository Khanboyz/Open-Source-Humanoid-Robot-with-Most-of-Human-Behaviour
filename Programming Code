...
/******************************************************************************************************/
void MHBHumanoid::my_name_is_IOB_1.0() {

  XT_Wav_Class PlayVoice(mynameisIOB1.0);
  PlayVoice.RepeatForever = false;
  DacAudio.Play(&PlayVoice);
  talking_face();
...
/******************************************************************************************************/
void MHBHumanoid::i_am_IOB() {

  XT_Wav_Class PlayVoice(iamamIOB);
  PlayVoice.RepeatForever = false;
  DacAudio.Play(&PlayVoice);
  talking_face();
...
void MHBHumanoid::i_can_do_facial_exp() {
  ...
  int pwm_array1[16] = {300, 100, 325, 325, 350, 550, 325, 325, 325, 325, 325, 325, 325, 325, 325, 325};
  int pwm_array2[16] = {200, 100, 325, 325, 350, 550, 325, 325, 325, 325, 325, 325, 325, 325, 325, 325};
  int pwm_array3[16] = {100, 100, 325, 325, 550, 550, 325, 325, 325, 325, 325, 325, 325, 325, 325, 325};
  move_servo(1500, pwm_array1);
  move_servo(1500, pwm_array2);
  move_servo(1500, pwm_array3);
  initial_face();
}
